    ...
    def _serializar_servicio(
        ...
        return ServicioLeer(
            ...
            tipo_servicio_nombre=getattr(
                ...
                TecnicoServicio._nombre_tipo_servicio(servicio.tipo_servicio),
            ),
            ...
            fecha_validacion=getattr(servicio, "fecha_validacion", None),
    ...
    def _serializar_detalle_servicio(
        ...
        return ServicioTecnicoDetalleLeer(
            ...
            tipo_servicio_nombre=getattr(
                servicio,
                "tipo_servicio_nombre",
                cls._nombre_tipo_servicio(servicio.tipo_servicio),
            ),
            valor_servicio=getattr(servicio, "valor_servicio", 0),
            estado=servicio.estado,
            placa_vehiculo=servicio.placa_vehiculo,
