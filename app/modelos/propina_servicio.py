...
class PropinaServicio(Base):
    __tablename__ = "propinas_servicio"
    __table_args__ = (UniqueConstraint("servicio_id", name="uq_propinas_servicio_id"),)
    ...
    servicio: Mapped[Servicio] = relationship(back_populates="propina")
    empresa_cliente: Mapped[EmpresaCliente] = relationship(back_populates="propinas")
    tecnico: Mapped[Tecnico] = relationship(back_populates="propinas")
